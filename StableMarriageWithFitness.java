...
public class StableMarriageWithFitness implements Problem {
    ...
    public StableMarriageWithFitness(int n, int[][] person, int[][] partner) {
        this.n = n;
        this.person = person;
    ...
    public Solution newSolution() {
        Solution solution = new Solution(1, 1); // 1 variable, 2 objectives
    ...
    public String getName() {
        return "Stable Marriage Problem With Fitness Function";
    }
    ...
    public void evaluate(Solution solution) {
        ...
        for(int i = 0; i < n ; i++){
            ...
            double individualSatisfaction = calculateIndividualCoupleSatisfaction(i, partner);

            // Calculate egalitarian for this couple after matching (Egalitarian = Pw - Pm, lower is more stable)
            double egalitarian = calculateEgalitarianOfEachCouple(i, partner);

            // Update overall satisfaction and total egalitarian
            overallSatisfaction += individualSatisfaction;
            totalEgalitarian += egalitarian;
        }
        totalEgalitarian = Math.abs(totalEgalitarian);
        //fitness function
        double fitnessScore = overallSatisfaction - 2*totalEgalitarian;
